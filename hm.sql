...
select  created_on,password from students where created_on = '2021-07-12 00:00:00' and password ='1m313';
--Вывести пользователей которые были созданы 2021-07-12 00:00:00 и у которых в имени есть слово Andrey
select created_on, name from students where created_on = '2021-07-12 00:00:00' and name like 'Andrey%';
--Вывести пользователей которые были созданы 2021-07-12 00:00:00 и у которых в имени есть цифра 8
select created_on , name from students where created_on = '2021-07-12 00:00:00' and name like '%8%';
...
select password from students where password in ('1233', '1m313', '123313');
--Вывести пользователей где created_on равен 2020-10-03 00:00:00, 2021-05-19 00:00:00, 2021-03-26 00:00:00
 select created_on from students where created_on in ('2020-10-03 00:00:00', '2021-05-19 00:00:00', '2021-03-26 00:00:00');
